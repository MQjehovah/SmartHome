...
* @{
*/
#define PRODUCT_KEY "210ce268d54f431eb56e5c908a781f03"
/**@} */
/**@name Product Secret (产品密钥)
* @{
*/
#define PRODUCT_SECRET "769bb821cafc4e15b99990d7d2aab8af"
/**@} */
...
#define SWITCH_BITOFFSET                     0
#define SWITCH_LEN                           1


#define LIGHTLEVEL_RATIO                         1
#define LIGHTLEVEL_ADDITION                      0
#define LIGHTLEVEL_MIN                           0
#define LIGHTLEVEL_MAX                           65536
